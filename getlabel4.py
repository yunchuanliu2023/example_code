...
# This shows the result of fully supervised learning after 
# shuffle and got the same distrubution of training and testing data
...
def run():
    ...
    # train_x, train_y,test_x, test_y =datapick2.top()   
    train_x, train_y,test_x, test_y  = topp()  
